...
const DB_NAME = "JournalStore";
const STORE_NAME = "JournalDB";
let NTName = "Journal"; // Default value
// Open IndexedDB
    ...
    dbPromise = new Promise((resolve, reject) => {
        setTimeout(() => {
            ...
            request.onerror = (event) => {
                ...
                panic(`Coudn't open IDB, which is a critical part of Journal.`);
            };
...
// The three following functions are the db to get Journal on it's feet before decryption
